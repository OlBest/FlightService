...
namespace FlightServer.localhost {
    ...
    public partial class FlightsService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public string Pay() {
            object[] results = this.Invoke("Pay", new object[0]);
        ...
        public string PayForTimeInMilliSeconds(long time) {
            object[] results = this.Invoke("PayForTimeInMilliSeconds", new object[] {
                        time});
            return ((string)(results[0]));
        }
        ...
        private void OnPayForTimeInMilliSecondsOperationCompleted(object arg) {
            if ((this.PayForTimeInMilliSecondsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.PayForTimeInMilliSecondsCompleted(this, new PayForTimeInMilliSecondsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.33440")]
    public delegate void PayForTimeInMilliSecondsCompletedEventHandler(object sender, PayForTimeInMilliSecondsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.33440")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class PayForTimeInMilliSecondsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal PayForTimeInMilliSecondsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
